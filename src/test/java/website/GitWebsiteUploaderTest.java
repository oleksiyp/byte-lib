...
public class GitWebsiteUploaderTest {
    ...
    public void testUpload() throws Exception {
        WebsiteUploader uploader = new GitWebsiteUploader(mainRepo, null, null, "daily", "Update");
    ...
    public void testUploadWithCache() throws Exception {
        try (Git cacheRepo = new Git(createTempDirectory("git-website-cache").toFile())
            ...
            WebsiteUploader uploader = new GitWebsiteUploader(mainRepo, cacheRepo, null, "daily", "Update");
